      ...
      <div className="p-1 md:p-4 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between pt-1 border-t border-[#F1F3F9]">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="bg-white rounded-[10px] border border-[#EBEEF7] shadow-[0px_5px_24px_0px_#0022330A] text-[#464D61] text-sm p-3"
            >
              <DropdownMenuItem className="flex items-center gap-3 p-2 rounded hover:bg-[#E8F7FF] hover:text-blue-600">
              ...
              <DropdownMenuItem className="flex items-center gap-3 p-2 rounded text-[#FF4F4F] hover:bg-[#FFECEC]">
                <Trash2Icon className="w-5 h-5 text-[#FF4F4F] " />
                Delete Ad
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
