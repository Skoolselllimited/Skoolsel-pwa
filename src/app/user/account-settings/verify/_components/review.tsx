    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="w-full h-full max-w-none max-h-none p-0 m-0 lg-md:w-[520px] lg-md:h-auto lg-md:max-w-[520px] lg-md:max-h-[95vh] lg-md:p-10 lg-md:bg-white lg-md:rounded-xl lg-md:m-auto border-0 shadow-none">
        ...
        <DialogHeader className="hidden lg-md:flex flex-col gap-8 mb-8">
          ...
          <DialogTitle className="flex flex-col gap-2 w-full max-w-[417px] h-16 text-[#0A243F] font-circular-std tracking-normal">
            <span className="font-medium text-[24px]/[32px]">
              Review your {getDocumentLabel(documentType)}
            </span>
            <span className="font-[450] text-[16px]/[24px]">
              Make sure your document is clear and all information is visible
            </span>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="relative w-full h-full lg-md:w-[439px] lg-md:h-[515px] overflow-hidden">
          ...
          {/* Document photo - Using regular img element for base64 support */}
          {documentPhoto ? (
            <img
              src={documentPhoto || "/placeholder.svg"}
              alt={`Your ${getDocumentLabel(documentType)}`}
              className="absolute left-1/2 top-1/3 lg-md:top-1/3 -translate-x-1/2 -translate-y-1/2 w-[92%] h-[280px] lg-md:w-[402px] lg-md:h-[267px] shadow-[0_0_0_9999px_rgba(0,0,0,0.7)] pointer-events-none z-30 object-cover rounded-md"
              onError={(e) => {
            ...
            <div className="absolute left-1/2 top-1/2 lg-md:top-1/3 -translate-x-1/2 -translate-y-1/2 w-[92%] h-[220px] lg-md:w-[402px] lg-md:h-[267px] bg-gray-200 rounded-lg border-2 border-white z-30 flex items-center justify-center">
              <span className="text-gray-500 text-sm">No photo captured</span>
            </div>
          )}

          {/* Instruction text positioned at bottom center of frame */}
          <div className="lg-md:hidden w-full max-w-[400.7px] absolute bottom-56 left-1/2 -translate-x-1/2 z-30">
        ...
        {/* Buttons - Fixed at bottom with higher z-index and better visibility */}
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-full max-w-[438px] px-4 space-y-3 z-[9999] lg-md:relative lg-md:bottom-auto lg-md:left-auto lg-md:translate-x-0 lg-md:mt-4 lg-md:px-0 lg-md:z-auto">
          <Button
            ...
            disabled={isConfirmed || !documentPhoto}
