        ...
        <form onSubmit={handleSearch} className="flex items-center">
          <div className="relative flex-1">
            <Input
              ...
              className="bg-white h-9 sm:h-10 lg:h-[56px] flex-1 border-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 pr-20 pl-1 lg:pl-2.5 font-nunito text-xs sm:text-sm text-foreground placeholder:text-[placeholder:text-[#8B90A0]]"
              autoComplete="off"
            />
            ...
            <div className="py-2">
              {filteredSuggestions.length > 0 ? (
                filteredSuggestions.map((suggestion, index) => (
                  ...
                  >
                    <div className="flex items-center gap-1 font-circular-std text-foreground">
                      <span>{suggestion.text} in </span>
                      <span
                        className="text-secondary font-circular-std font-medium cursor-pointer hover:underline"
                        onClick={(e) => {
                          e.stopPropagation()
